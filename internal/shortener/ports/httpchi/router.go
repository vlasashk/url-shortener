...
import (
	...
	"github.com/vlasashk/url-shortener/internal/shortener/ports/httpchi/handlers/healthz"
...
func New(cfg config.ShortenerCfg, res resources.Resources) *http.Server {
	r := chi.NewRouter()
